    ...
    private static function baselines(): array {
        return [
            ...
            'de' => [
                ...
                'clarification.contact'   => 'Darf ich kurz fragen: Möchten Sie lieber das Kontaktformular nutzen oder direkt einen Termin vereinbaren?',
                'post_abort.followup'    => 'Haben Sie noch Fragen, oder möchten Sie lieber das Kontaktformular öffnen?',
            ...
            'en' => [
                ...
                'clarification.contact'   => 'Quick check: would you prefer to use the contact form or schedule an appointment directly?',
                'post_abort.followup'    => 'Would you like to continue with more questions, or should I open the contact form instead?',
